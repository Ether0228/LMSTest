...
def weekly_payload(data: dict[str, Any], results: dict[str, Any]) -> dict[str, Any]:
    ...
    payload = {
        ...
        "grade_series": data.get("grade_series", []),
        "courses": data.get("report_courses", []),
        "ielts_report": data.get("ielts_report", {}),
        "pbl_report": data.get("pbl_report", {}),
        "confirmed_next_actions": data.get("confirmed_next_actions", []),
